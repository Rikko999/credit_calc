RSpec.describe CalculatorData do
  subject { CalculatorData.new(instance_of(BigDecimal), instance_of(BigDecimal), instance_of(BigDecimal), instance_of(BigDecimal)) }
